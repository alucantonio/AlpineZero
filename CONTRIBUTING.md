...
Welcome to `AlpineZero` contributor's guide.
...
If you experience bugs or general issues with `AlpineZero`, please have a look
...
You can help improve `AlpineZero` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`AlpineZero` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `AlpineZero`'s files. While this mechanism can
...
```
conda create -n AlpineZero python=3 six virtualenv pytest pytest-cov
conda activate AlpineZero
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/AlpineZero.git
   cd AlpineZero
   ```
...
5. Install [pre-commit]:
   ...
   `AlpineZero` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/AlpineZero
[issue tracker]: https://github.com/<USERNAME>/AlpineZero/issues
